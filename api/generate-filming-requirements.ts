...
): GenerateFilmingRequirementsRequest {
...
function validateGeneratedJson(
  ...
  const requirements = ensureCoreRequirements(
    normalizeStringList(record.requirements),
    input,
  );
      ...
      messages: [
        {
          role: "system",
          content:
            "你是熟悉美国 TikTok Shop 达人合作的中文运营助手。你只输出可解析 JSON。",
        },
        {
          role: "user",
