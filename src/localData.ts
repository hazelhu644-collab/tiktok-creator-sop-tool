...
export function withNormalizedVideoProgressWarning(row: CreatorRow): CreatorRow {
...
export function updateCreatorField(row: CreatorRow, field: EditableField, value: string): CreatorRow {
  ...
  return field === 'videoProgress' ? withNormalizedVideoProgressWarning(updated) : updated;
}
...
function coerceStoredRow(value: unknown, index: number): CreatorRow {
  ...
  return withNormalizedVideoProgressWarning({
